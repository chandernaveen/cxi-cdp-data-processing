...
class Customer360SignalsJobSpecificPartnerLocationSignalsTest extends BaseSparkBatchJobTest {
    ...
    def signalUniverseDf: Dataset[SignalUniverse] = {
        ...
        val burgerAffinity = SignalUniverse(
            "food_and_drink_preference",
            "Food and Drink Preference",
            "burger_affinity",
            "Burger Affinity",
            "food_and_drink_preference.burger_affinity_boolean",
            "boolean",
            "test description",
            "boolean",
        ...
        val colaAffinity = SignalUniverse(
            "food_and_drink_preference",
            "Food and Drink Preference",
            "cola_affinity",
            "Cola Affinity",
            "food_and_drink_preference.cola_affinity_boolean",
            "boolean",
            "test description",
            "boolean",
            signalConfigCreateDate,
        ...
        val deliveryPreferred = SignalUniverse(
            "channel_preferences",
            "Channel Preferences",
            "delivery_preferred",
            "Delivery Preferred",
            "channel_preferences.delivery_preferred_boolean",
            "boolean",
            "test description",
            "boolean",
            signalConfigCreateDate,
        ...
        val reachibilityEmail = SignalUniverse(
            "campaign",
            "Campaign",
            "reachability_email",
            "Reachability - Email",
            "campaign.reachability_email_boolean",
            "boolean",
            "test description",
            "boolean",
            signalConfigCreateDate,
        ...
        val ageCategory = SignalUniverse(
            "profile",
            "Profile",
            "age_category",
            "Age Category",
            "profile.age_category_keyword",
            "keyword",
            "test description",
            "enumeration",
            signalConfigCreateDate,
        ...
        val gender = SignalUniverse(
            "profile",
            "Profile",
            "gender",
            "Gender",
            "profile.gender_keyword",
            "keyword",
            "test description",
            "enumeration",
            signalConfigCreateDate,
        ...
        val loyaltyType = SignalUniverse(
            "loyalty",
            "Loyalty",
            "loyalty_type",
            "Loyalty Type",
            "loyalty.loyalty_type_keyword",
            "keyword",
            "test description",
            "enumeration",
            signalConfigCreateDate,
            ...
            true,
            true,
            SignalType.SpecificPartnerLocationSignal.code,
            "specific_partner_location_signals"
        )
        val timeOfDayEarlyAfternoon = SignalUniverse(
            "time_of_day_metrics",
            "Time of Day early afternoon",
            "early_afternoon",
            "Time of Day early afternoon",
            "time_of_day_metrics.early_afternoon_long",
            "long",
            "test description",
            "number",
            signalConfigCreateDate,
        ...
        val physicalLaneChannelMetric = SignalUniverse(
            "channel_metrics",
            "Physical Lane",
            "physical_lane",
            "Physical Lane",
            "channel_metrics.physical_lane_long",
            "long",
            "test description",
            "number",
            signalConfigCreateDate,
        ...
        val digitalWebChannelMetric = SignalUniverse(
            "channel_metrics",
            "Digital Web",
            "digital_web",
            "Digital Web",
            "channel_metrics.digital_web_long",
            "long",
            "test description",
            "number",
            signalConfigCreateDate,
        ...
        val totalOrdersOrderMetric = SignalUniverse(
            "order_metrics",
            "Total orders",
            "total_orders",
            "Total orders",
            "order_metrics.total_orders_long",
            "long",
            "test description",
            "number",
            signalConfigCreateDate,
        ...
        val cashTenderTypeMetric = SignalUniverse(
            "tender_type_metrics",
            "Cash Tender Type",
            "cash",
            "Cash Tender Type",
            "tender_type_metrics.cash_long",
            "long",
            "test description",
            "number",
            signalConfigCreateDate,
        ...
        Seq(
            ...
            timeOfDayEarlyAfternoon,
            physicalLaneChannelMetric,
            digitalWebChannelMetric,
            totalOrdersOrderMetric,
            cashTenderTypeMetric
        ).toDS()
    }
    ...
    test("test read daily partner location signals") {
        ...
        val partnerLocationDailySignals = Seq(
            ...
            (
                "partner1",
                "locid1",
                CustomerMetricsTimePeriod.Period7days.value,
                "cust_id1",
                "channel_metrics",
                "physical_lane",
                0L.toString,
            ...
            (
                "partner1",
                "locid2",
                CustomerMetricsTimePeriod.Period30days.value,
                "cust_id1",
                "channel_metrics",
                "physical_lane",
                1L.toString,
            ...
            (
                "partner5",
                "locid55555",
                CustomerMetricsTimePeriod.Period90days.value,
                "cust_id3",
                "channel_metrics",
                "physical_lane",
                2L.toString,
                sqlDate(feedDate.minusDays(1))
            )
        ).toDF(
            "cxi_partner_id",
            "location_id",
        ...
        // when
        val actual = Customer360SignalsJob.readPartnerLocationDailySignals(
            spark,
            partnerLocationDailySignalsTable,
            feedDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))
        )
        // then
        val actualFieldsReturned = actual.schema.fields.map(f => f.name)
        withClue("Actual fields returned:\n" + actual.schema.treeString) {
    ...
    test("test read partner location weekly signals") {
        ...
        val partnerLocationWeeklySignals = Seq(
            ...
            (
                ...
                "loyalty_type",
                "new",
                sqlDate(signalGenerationDate.plusDays(1))
            ),
            ...
            (
                ...
                "loyalty_type",
                "new",
                sqlDate(signalGenerationDate.minusDays(1))
            )
        ).toDF(
            "cxi_partner_id",
            "location_id",
        ...
        withClue(
            "Transform data does not match." + actualData
                .map(_.json)
                .mkString("\nActual data:\n", "\n-----------------------\n", "\n\n")
        ) {
            val expected = Seq(
    ...
    test("test process specific partner location customer signals") {
        ...
        val partnerLocationWeeklySignals = Seq(
            ...
            (
                ...
                "loyalty_type",
                "at-risk",
                sqlDate(weeklySignalGenerationDate)
            ),
            (
                "partner1",
                "locid2",
        ...
        // when
        val actual = Customer360SignalsJob.processPartnerLocationSignals(
            spark,
            locationsTable,
            partnerLocationWeeklySignalsTable,
            partnerLocationDailySignalsTable,
            spark.table(signalUniverseTable).as[SignalUniverse].filter(_.is_active),
            feedDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))
        )
        ...
        val partnerLocationEntrySchema = DataTypes.createStructType(
            Array(
                ...
                StructField(
                    "time_period_7",
                    DataTypes.createMapType(StringType, DataTypes.createMapType(StringType, StringType, true)),
                    true
                ),
                StructField(
                    "time_period_30",
        ...
        val outputToEsSchema = DataTypes.createStructType(
            Array(
                StructField("customer_360_id", StringType),
                StructField(
                    "specific_partner_location_signals",
                    DataTypes.createArrayType(partnerLocationEntrySchema, false),
                    false
                )
            )
        )
