...
class PreAggrTransactionalInsightsServiceTest extends BaseSparkBatchJobTest with Matchers {
    ...
    test("getCustomer360IdWithMetrics") {
        ...
        val orderSummaryWithMetrics = List(
            ...
            ("1", Date.valueOf("2022-03-01"), "partner-1", "location-1",
                Seq(CxiIdentityId("phone", "111")), Some(1L), Some(1234L)),

            // multiple locations, partners, customer 360 ID-to-cxiIdentityId mappings
            // customer-1
            ("2", Date.valueOf("2022-03-02"), "partner-2", "location-1",
                Seq(CxiIdentityId("phone", "111")), Some(13L), Some(7800L)),
            ("3", Date.valueOf("2022-03-02"), "partner-2", "location-2",
                Seq(CxiIdentityId("phone", "111")), Some(2L), Some(300L)),
            ("4", Date.valueOf("2022-03-02"), "partner-2", "location-2",
                Seq(CxiIdentityId("phone", "111")), Some(3L), Some(500L)),
            // customer-2
            ("5", Date.valueOf("2022-03-02"), "partner-1", "location-1",
                Seq(CxiIdentityId("phone", "222"), CxiIdentityId("phone", "333")), Some(2L), Some(2345L)),
            ("6", Date.valueOf("2022-03-02"), "partner-1", "location-2",
                Seq(CxiIdentityId("phone", "222")), Some(3L), Some(3456L)),
            ("7", Date.valueOf("2022-03-02"), "partner-2", "location-1",
                Seq(CxiIdentityId("phone", "333")), Some(2L), Some(5000L)),

            // no corresponding customer 360 ID
            ("8", Date.valueOf("2022-03-03"), "partner-1", "location-1",
                Seq(CxiIdentityId("phone", "555")), Some(4L), Some(4567L))
        ).toDF(
            "ord_id",
            "ord_date",
            "cxi_partner_id",
