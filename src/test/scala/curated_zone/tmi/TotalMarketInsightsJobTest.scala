...
class TotalMarketInsightsJobTest extends BaseSparkBatchJobTest {
    ...
    test("test partner market insights computation") {
        ...
        ).toDF("ord_id", "cxi_partner_id", "location_id", "location_nm", "city", "state", "region", "ord_date", "location_type", "ord_pay_total")
        ...
        withClue("Actual fields returned:\n" + actual.schema.treeString) {
            actualFieldsReturned should contain theSameElementsAs
                Seq("cxi_partner_id", "location_type", "region", "state", "city", "location_id", "location_nm", "date", "transaction_amount", "transaction_quantity")
        }
        ...
        withClue("Partner market insights data do not match") {
            ...
            ).toDF("cxi_partner_id", "location_type", "region", "state", "city", "location_id", "location_nm", "date", "transaction_amount", "transaction_quantity").collect()
    ...
    test("test total market insights computation") {
        ...
        ).toDF("cxi_partner_id", "location_type", "region", "state", "city", "location_id", "location_nm", "date", "transaction_amount", "transaction_quantity")
