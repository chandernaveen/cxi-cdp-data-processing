...
class DemographicIdentityRelationshipsJobTest extends BaseSparkBatchJobTest {
    ...
    test("test read aaid maid data") {
        ...
        val rawSourceData = Seq(
            Row(
                ...
                "314830913",
                "2022-03-20",
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "4da5d46e-114d-408e-95ac-d01dab3330c1",
                "03d1e62bc6cf4e7b1ffd4aa649eba1c4ba79728160c393309dd1e0982bb45d76"
            ), // diff feed date, filtered out
            Row(
                "120087649",
                "314830913",
                feedDate,
            ...
            Row(
                ...
                feedDate,
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "d2845ac6-628b-428b-a597-767a072d0251",
                "1aaff06a947d87deac6ebe0de5d28b94c21b355297216001dd14acbb76fdfec8"
            ),
            Row(
                "87737670",
                "246824989",
                feedDate,
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "a69acbcf-d7f5-4638-940f-3d663c1e75f8",
                "1cafc88274eb249b19cdffdf4c0a247c0c0e6fcac63d8cf032fbfac52f6f7dac"
            ),
            Row(
                "35092699",
                "405203644",
                feedDate,
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "4ebe43b0-e92b-4938-bf3a-15d5ed3ec497",
                "214d817ddf2c119debc89c764a714ff64ba7368fa53a2ebbe803a8aef3288a7b"
            )
        )
    ...
    test("test read email data") {
        ...
        val rawSourceData = Seq(
            ...
            Row(
                ...
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "d2845ac6-628b-428b-a597-767a072d0251",
                "5778fdfa1f81d67da22f1f1319350ad7560d1ce55787d687dab5e69777a1509d"
            ),
            Row(
                "35092699",
                "405203644",
                ...
                "part-00035-4d621c35-8bb5-4f54-a07d-e00f8bf8a440-c000.csv.gz",
                "4ebe43b0-e92b-4938-bf3a-15d5ed3ec497",
                "e02b5a75553bc94932ad2196be1821941f5ef8922b7656f5102ee2aa6c115b50"
            )
        )
    ...
    test("test throtle transform maid") {
        ...
        import collection.JavaConverters._
        val rawIDFA = spark.createDataFrame(
            Seq(
                ...
                Row("35092699", "4ebe43b0-e92b-4938-bf3a-15d5ed3ec497")
            ).asJava,
            rawStruct
        )

        val rawAAID = spark.createDataFrame(
            Seq(
                ...
                Row("28606737786", "a69acbcf-d7f5-4638-940f-3d663c1e75f8")
            ).asJava,
            rawStruct
        )
    ...
    test("test throtle transform email") {
        ...
        val rawEmail = spark.createDataFrame(
            Seq(
                ...
                Row(
                    "187407107",
                    "7c53a3ac6e326f3b1570fded173d611ac1f1fb54249c5bc32728f5545401d7dd"
        ...
        val rawPrivacy = spark.createDataFrame(
            Seq(
                Row(
                    ...
                    "cxi-usa-goldbowl",
                    "vfalosito@gmail.com",
                    "001c553ca1b16d9fd1bc089b8c94efa57dbc67f9dc7f406e066786a999fd0b0c",
                    "json-crypto-hash",
                    "2022-01-27T15:41:59.149+0000",
                    "5778fdfa1f81d67da22f1f1319350ad7560d1ce55787d687dab5e69777a1509d"
                ),
                Row(
                    "USA",
                    "cxi-usa-goldbowl",
                    "mbateman5@gmail.com",
                    "00bd58ab420d6ef94bb0cb8702b31f560653b3f81d1227d59eb894b066a9d653",
                    "json-crypto-hash",
                    "2022-01-27T15:41:59.149+0000",
                    "acb2d85813d85ac0689f9d38b977f4197eb93c4a78ccf5b5224ead03f61f5b98"
                ),
                Row(
                    "USA",
                    "cxi-usa-goldbowl",
                    "dan_lopez23@yahoo.com",
                    "01209b23560558fcc6c8b40850f59d0253264eb10a0b5116b66604f2555744f7",
                    "json-crypto-hash",
                    "2022-01-27T15:54:06.946+0000",
                    "e02b5a75553bc94932ad2196be1821941f5ef8922b7656f5102ee2aa6c115b50"
                )
            ).asJava,
            rawStructPrivacy
    ...
    test("test transform demographic identity") {
        ...
        // when
        val actual = DemographicIdentityRelationshipsJob.transformDemographicIdentity(
    ...
    test("test transform demographic identity relationship") {
        ...
        // when
        val actual = DemographicIdentityRelationshipsJob.transformDemographicIdentityRelationship(
            transformedThrotleMaids,
            transformedThrotleEmail,
            runDate
        )
