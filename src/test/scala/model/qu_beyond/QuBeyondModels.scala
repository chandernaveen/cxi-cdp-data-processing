...
case class Data(cash_deposits: Array[String] = null,
...
case class Item(barcode: String = null,
...
case class Discount(check_title: String = null,
...
case class Employee(clock_in_required: Option[Boolean] = Option.empty,
                    email: String = null,
...
case class EmployeeJob(end_date: String = null,
               id: Option[Long] = Option.empty,
               name: String = null,
...
case class PreviousInstancesItem(amount: Option[Double] = Option.empty,
...
case class Payment(auto_gratuity: Option[Long] = Option.empty,
                   cash_tip: Option[Long] = Option.empty,
...
case class CheckDiscount(amount: Option[Double] = Option.empty,
                         applied_at: String = null,
                         discount_id: Option[Long] = Option.empty,
                         quantity: Option[Long] = Option.empty)

case class CheckChildItem(amount: Option[Double] = Option.empty,
...
case class CheckChildItemLevel2(amount: Option[Long] = Option.empty,
                                is_return: Option[Boolean] = Option.empty,
                                is_void: Option[Boolean] = Option.empty,
                                item_id: Option[Long] = Option.empty,
                                portion_id: Option[Long] = Option.empty,
...
case class CheckVoid(applied_at: String = null,
                     approver_id: Option[Long] = Option.empty,
                     void_id: String = null)

case class CheckItem(amount: Option[Double] = Option.empty,
                     category_id: Option[Long] = Option.empty,
...
case class CheckServiceCharge(amount: Option[Double] = Option.empty,
                              quantity: Option[Long] = Option.empty,
                              service_charge_id: Option[Long] = Option.empty)

case class ItemGroup(id: Option[Long] = Option.empty,
                     items: Array[Long] = null, name: String = null)

case class Job(id: Option[Long] = Option.empty,
               name: String = null)

case class Labor(auto_clock_out: Option[Boolean] = Option.empty,
                 employee_id: Option[Long] = Option.empty,
...
case class LaborTimeEntries(activity: String = null,
...
case class Location(address1: String = null,
...
case class OrderChannel(id: Option[Long] = Option.empty,
                        name: String = null)
case class OrderType(id: Option[Long] = Option.empty,
                     name: String = null)
case class PaidInout(id: String = null,
                     name: String = null)
case class PaidInouts(amount: Option[Long] = Option.empty,
                      applied_at: String = null,
                      employee_id: Option[Long] = Option.empty,
                      paid_inout_id: String = null,
                      reason_text: String = null)
case class PaymentType(id: String = null,
                       is_deleted: Option[Boolean] = Option.empty,
                       modified_at: String = null,
                       name: String = null,
                       payment_type_category: String = null)

case class PayrollProfile(break_type: String = null,
...
case class Portion(id: Option[Long] = Option.empty,
                   name: String = null)

case class ServiceCharge(check_title: String = null,
                         id: Option[Long] = Option.empty,
                         is_deleted: Option[Boolean] = Option.empty,
                         modified_at: String = null,
                         name: String = null,
...
case class Tax(check_title: String = null,
               id: Option[Long] = Option.empty,
               is_deleted: Option[Boolean] = Option.empty,
               modified_at: String = null,
               name: String = null,
...
case class Tills(auto_closed: Option[Boolean] = Option.empty,
...
case class PaidIns(amount: Option[Long] = Option.empty,
                   comment: String = null,
                   date_time: String = null,
                   employee_id: Option[Long] = Option.empty,
...
case class PaidOuts(amount: Option[Long] = Option.empty,
                    comment: String = null,
                    date_time: String = null,
                    employee_id: Option[Long] = Option.empty,
                    ending_cash: Option[Long] = Option.empty,
...
case class Reconciliation(actual_cash: Option[Long] = Option.empty,
                          date_time: String = null,
                          expected_cash: Option[Double] = Option.empty,
                          over_under: Option[Double] = Option.empty,
                          tips: Option[Long] = Option.empty)

case class Skims(amount: Option[Long] = Option.empty,
                 date_time: String = null,
                 employee_id: Option[Long] = Option.empty,
                 ending_cash: Option[Long] = Option.empty,
                 starting_cash: Option[Long] = Option.empty)

case class TimeEntryReasons(id: String = null,
                            name: String = null,
                            `type`: String = null)

case class Void(id: String = null,
                name: String = null)

case class DataDelta(date: String = null,
                     time: String = null)


case class QuBeyondLandingZoneModel(data: Data = null,
...
case class QuBeyondRawZoneModel(record_type: String = null,
