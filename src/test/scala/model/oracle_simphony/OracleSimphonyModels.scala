...
case class Employee(
    employeeId: Option[Long] = Option.empty,
    fName: String = null,
...
case class GuestCheck(
    balDueTtl: String = null,
...
case class DetailLineMenuItem(
    activeTaxes: String = null,
    miNum: Option[Long] = Option.empty,
    prcLvl: Option[Long] = Option.empty
)

case class Other(detailNum: Option[Long] = Option.empty, detailType: Option[Long] = Option.empty)

case class DetailLine(
    aggQty: Option[Long] = Option.empty,
...
case class Location(
    active: Option[Boolean] = Option.empty,
    locRef: String = null,
    name: String = null,
    openDt: String = null,
    srcName: String = null,
...
case class NonSalesTransaction(
    chkNum: Option[Long] = Option.empty,
    empNum: Option[Long] = Option.empty,
...
case class RevenueCenter(
    logDetails: Array[LogDetail] = null,
    name: String = null,
    num: Option[Long] = Option.empty,
    rvcNum: Option[Long] = Option.empty
)
...
case class ServiceCharge(
    chrgTipsFlag: Option[Boolean] = Option.empty,
    name: String = null,
    num: Option[Long] = Option.empty,
...
case class TenderMedia(name: String = null, num: Option[Long] = Option.empty, `type`: Option[Long] = Option.empty)

case class OracleSimphonyLabLandingModel(
    busDt: String = null,
...
case class OracleSimphonyLabRawModel(
    cur_utc: String = null,
    loc_ref: String = null,
    bus_dt: String = null,
...
case class Discount(name: String = null, num: Option[Long] = Option.empty, posPercent: Option[Long] = Option.empty)
