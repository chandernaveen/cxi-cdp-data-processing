    ...
    test("test Segmint transformation with raw data") {
        ...
        val landingRawSourceData = Seq(
            Row(
                ...
                "2022-02-06",
                "202102_cxi_age_category.csv.gz",
                "5635dc0e-637f-4765-85ea-974560384d1a"
            ),
            Row(
                """"2021-02"|"CARL'S JR."|"FOOD AND DINING"|"FAST FOOD HAMBURGER RESTAURANTS"|""|""|93|106|3068.61|28.95""",
                "2022-02-06",
                "202102_cxi_age_merch.csv.gz",
                "5635dc0e-637f-4765-85ea-974560384d1b"
            ),
            Row(
                """"2021-02"|"CARL'S JR."|"FOOD AND DINING"|"FAST FOOD HAMBURGER RESTAURANTS"|""|""|93|106|3068.61|28.95""",
                "2022-02-06",
                "202102_cxi_zip_merch.csv.gz",
                "5635dc0e-637f-4765-85ea-974560384d1c"
            ),
            Row(
                """"2021-02"|"CARL'S JR."|"FOOD AND DINING"|"FAST FOOD HAMBURGER RESTAURANTS"|""|""|93|106|3068.61|28.95""",
                "2022-02-06",
                "202102_cxi_zip_merch.csv.gz",
                "5635dc0e-637f-4765-85ea-974560384d1d"
            ),
            Row(
                """"2021-02"|"CARL'S JR."|"FOOD AND DINING"|"FAST FOOD HAMBURGER RESTAURANTS"|""|""|93|106|3068.61|28.95""",
                "2022-02-06",
                "202102_cxi_zip_merch.csv.gz",
                "5635dc0e-637f-4765-85ea-974560384d1e"
            )
        )
