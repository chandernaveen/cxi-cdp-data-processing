...
case class LineItem(applied_discounts: Array[AppliedDiscount] = null,
...
case class PricingBlocklists(blocked_discounts: Array[BlockedDiscount] = null,
                             blocked_taxes: Array[BlockedTax] = null)
...
case class Modifier(base_price_money: BasePriceMoney = null,
                    catalog_object_id: String = null,
                    catalog_version: Option[Long] = Option.empty,
                    name: String = null,
