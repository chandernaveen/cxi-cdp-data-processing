...
case class Variation(
    absent_at_location_ids: Array[String] = null,
...
case class ItemVariationData(
    available_for_booking: Option[Boolean] = Option.empty,
    item_id: String = null,
...
case class PriceMoney(amount: Option[Long] = Option.empty, currency: String = null)
