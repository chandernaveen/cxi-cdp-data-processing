...
class RegularCustomerService extends Serializable {
    ...
    def getRegularCustomersPerPartnerAndLocation
        (customer360orders: DataFrame, newLoyalAtRiskPerLocation: DataFrame, endDate: String, regularCustomerTimeframeDays: Int): DataFrame = {
    ...
    def getRegularCustomersPerPartnerAllLocations
        (customer360orders: DataFrame, newLoyalAtRiskAllLocations: DataFrame, endDate: String, regularCustomerTimeframeDays: Int): DataFrame = {
