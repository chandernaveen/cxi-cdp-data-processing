...
object TransactionalInsightsSignalsJob {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val signalsTableName =
            contract.prop[String]("datalake.curated.customer_360_partner_location_daily_signals_table")
    ...
    private def collectSignalsForTimePeriod(
        feedDate: String,
        ...
        val startDate = LocalDate
            .parse(feedDate)
            .minusDays(timePeriod.numberOfDays - 1)
